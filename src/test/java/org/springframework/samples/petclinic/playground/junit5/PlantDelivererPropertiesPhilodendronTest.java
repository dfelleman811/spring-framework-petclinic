...
@TestPropertySource("classpath:phil.properties")
@ActiveProfiles("external-properties")
@SpringJUnitConfig(classes = PlantDelivererPropertiesPhilodendronTest.TestConfig.class)
public class PlantDelivererPropertiesPhilodendronTest {
